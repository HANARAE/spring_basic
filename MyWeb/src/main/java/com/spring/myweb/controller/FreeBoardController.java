...
public class FreeBoardController {
	...
	/*
	 ...
	 파라미터 값에 .이 포함되어 있다면 .뒤의 값은 잘린다.
	 {}안에 변수 명을 지어주고, @PathVariable괄호 안에 영역을 지목해서 값을 받아온다.
	 */
	@GetMapping("/content/{bno}")
	public String getContent(@PathVariable("bno") int bno, @ModelAttribute("p") PageVO vo, Model model) {
